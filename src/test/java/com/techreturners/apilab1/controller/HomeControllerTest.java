...
//tells the test class to enable and configure auto-configuration of MockMvc.
//MockMvc is the Main entry point for server-side Spring MVC testing
//useful because you can test the controller without running the controller within a server
...
class HomeControllerTest {
    ...
    public void testGetHome() throws Exception {
        //Arrange, Act and Assert chained within the following statement
